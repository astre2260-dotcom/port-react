  ...
  return (
        ...
        <div className="skill__inner">
            ...
            <div className="skill__desc">
                            <span>1.</span> 
                            <h3>웹개발을 지향하는 이유</h3><br/>
                            <p> 
                            웹 개발은 누구나 접근할 수 있는 플랫폼을 통해 문제를 해결하고 정보를 공유할 수 있는 최적의 환경이라고 생각합니다. 저는 웹 개발을 통해 사용자에게 실질적인 가치를 제공하는 서비스를 만들고 싶습니다.<br/><br/> 빠르게 변화하는 웹 기술과 트렌드를 배우고 적용하며 성장하는 것을 목표로 하고 있습니다.
                            </p>
                            <h3>프로젝트에서 가장 중요하게 생각하는 가치관 </h3><br/>
                            <p> 
                            변화하고 발전하는 IT 서비스 환경에서 다양한 직군들과 협업을 통해 개선된 서비스를 목표로 하는 직무라고 생각합니다. 저는 대학 시절 다양한 팀 프로젝트를 통해 문제 해결과 협업의 가치를 실현한 경험이 있습니다.<br/><br/> 이러한 과정에서 존중과 자기객관화를 통해 원활한 협업을 이끌었으며 이를 바탕으로 끊임없는 자기개발이 중요하다는 것을 깨달았습니다.
                            </p>

                            <h3>JavaScript로 개발을 한 이유 </h3><br/>
                            <p> 
                            JavaScript를 활용한 개발은 실제 사용자 환경에서 발생할 수 있는 다양한 상호작용을 이해하고 이를 기반으로 테스트 케이스를 설계하며 개발 환경에서 자주 사용되는 언어라고 생각합니다. <br/><br/> 프로젝트를 진행하면서 코드의 가독성과 유지보수성을 높이는 방법을 고민했고 개발자와의 원활한 소통에도 기여할 수 있다고 생각합니다.
                            </p>
